    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.IntegerField(blank=True, choices=[(0, 'Actor'), (1, 'Regisseur'), (2, 'MovieNews')], default=0, null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('name', models.CharField(blank=True, max_length=225, null=True)),
                ('status', models.IntegerField(blank=True, choices=[(0, 'Movie'), (1, 'News'), (2, 'MovieNews')], default=0, null=True)),
            ],
            options={
                'abstract': False,
            },
